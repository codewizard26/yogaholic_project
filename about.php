...
<a href="logout.php"><button style="float:right;display:inline-block; margin-left: 0.4rem; padding:6px;" class="btn btn-danger btn-lg">Signout</button></a>
<?php
  }
  if($UserAuthenticated==0){
    ?>
<a href="login.html"><button style="float:right;display:inline-block;padding:6px;" class="btn btn-primary btn-lg">Login</button></a>
    <?php
  }
  ?> 
  <h1 class="text-white" style="margin-left: 1vw;"><i class="fa fa-hacker-news" aria-hidden="true "></i> Yogaholic</h1>
  <div class="animate">
...
<div class="bg-light" style="width:100%;color: #2c7c7e">
    <div class="container text-center heading-about">
      about
    </div>
      <div class=" container mt-1 text-center quote-about" >
...
<div class="portfolio">
  <div class="self-img" style="background-color:rgb(244, 127, 10); margin-bottom:3rem;"></div>
        <div class="about-text" >
          ...
          and their are my several projects on various designing platforms. I always try to give my best on each and every projects.I enjoy work that challenges me to learn something new and stretch in a different direction.
...
<div class="container about-self">
  <div class="row">
    <div class="col-sm" style="padding:2rem; margin-top:1rem;">
